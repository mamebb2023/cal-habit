...
const Page = () => {
  ...
  return (
    <div className="p-2">
      ...
      {/* Habits title */}
      <div className="px-3 py-2 bg-white rounded-2xl shadow-2xl flex items-center justify-between">
      ...
      <div className="flex justify-center flex-wrap gap-3 p-3">
        {months.map((month, monthIndex) => {
          ...
          return (
            // calendar box
            <div key={monthIndex} className="w-[300px] px-3 py-2 bg-white rounded-2xl shadow-2xl">
